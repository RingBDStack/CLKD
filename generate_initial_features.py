...
if __name__ == "__main__":
    ...
    parser.add_argument('--lang', type=str, default='Arabic')
    parser.add_argument('--TransLine',type=bool,default=False)
    parser.add_argument('--TransNonline',type=bool,default=False)
    parser.add_argument('--tgt',type=str,default='English')
    parser.add_argument('--embpath',type=str,default='./datasets/dictrans/ar-en-for.npy')
    parser.add_argument('--wordpath',type=str,default='./datasets/dictrans/wordsArabic.txt')
